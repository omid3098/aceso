...
def test_weekly_report_with_trend_arrows():
    this_week = [MagicMock(**{"__getitem__": lambda self, k: {"back_pain": 7, "headache": None, "peace_level": None, "sleep_quality": 6, "stress_level": None, "anxiety_level": None, "water_amount": None, "caffeine_amount": None, "screen_hours": None, "sitting_hours": None, "smoke_count": 3}.get(k)})]
    prev_week = [MagicMock(**{"__getitem__": lambda self, k: {"back_pain": 4, "headache": None, "peace_level": None, "sleep_quality": 8, "stress_level": None, "anxiety_level": None, "water_amount": None, "caffeine_amount": None, "screen_hours": None, "sitting_hours": None, "smoke_count": 1}.get(k)})]
...
def test_daily_summary_with_data():
    db.insert_log(user_id=1, back_pain=5, water_amount=8, smoke_count=2, food_details="rice")
